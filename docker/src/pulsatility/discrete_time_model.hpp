//
//  discrete_time_model.hpp
//  pulsatility
//
//  Created by Margaritis Voliotis on 18/12/2023.
//

#ifndef discrete_time_model_hpp
#define discrete_time_model_hpp
...
namespace mci {
    namespace models {
        ...
        class discrete_time_model  : public basic_model{
        ...
        private:
            ...
            /** list of names of inferred parameters**/
            std::vector<std::string> iparam_names;
            
            /** list of indices of inferred parameters**/
            std::vector<size_t> iparam_id;
            ...
            /** number of parameters for which grad info is calculated**/
            size_t grad_num;
        ...
        public:
            ...
            const static std::string PARAM_f_Beta_prior_alpha ;
            const static std::string PARAM_f_Beta_prior_beta ;
            
            /** Create a model object **/
            discrete_time_model(const model_params_t& p, const mci::stochastic& r, const std::vector<std::string>& pi) ;
