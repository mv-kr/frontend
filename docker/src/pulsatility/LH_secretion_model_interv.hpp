...
#ifndef dual_mode_model_diff_hpp
#define dual_mode_model_diff_hpp
...
namespace mci {
    namespace models {
        ...
        class LH_secretion_model_interv  : public basic_model{
        ...
        public:
            ...
            LH_secretion_model_interv(const model_params_t& p, const mci::stochastic& r, const std::vector<std::string>& pi) ;
...
#endif /* dual_mode_model_diff_hpp */
