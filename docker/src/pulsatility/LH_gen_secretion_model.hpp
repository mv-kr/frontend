//
//  LH_gen_secretion_model.hpp
//  pulsatility
//
//  Created by Margaritis Voliotis on 30/10/2024.
//

#ifndef LH_gen_secretion_model_hpp
#define LH_gen_secretion_model_hpp
...
namespace mci {
    namespace models {
        ...
        class LH_gen_secretion_model  : public basic_model{
        ...
        public:
            ...
            LH_gen_secretion_model(const model_params_t& p, const mci::stochastic& r, const std::vector<std::string>& pi) ;
...
#endif /* LH_gen_secretion_model_hpp */
